...
public:
    ...
    void onConnect(myo::Myo* myo, uint64_t timestamp, myo::FirmwareVersion firmwareVersion)
    {
        ...
        c[identifyMyo(myo)] = 0;
        connected[identifyMyo(myo)] = true;
    }
    ...
    void onDisconnect(myo::Myo* myo, uint64_t timestamp)
    {
        ...
        c[identifyMyo(myo)] = 0;
        connected[identifyMyo(myo)] = false;
    }
    ...
    map<size_t, int> c;
    map<size_t, bool> connnected;
    map<size_t, myo::Myo*> whatMyo;
    map<size_t, float[]> target;
};
